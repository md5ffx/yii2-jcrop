...
<div class="cropper-widget">
    ...
    <div class="new-photo-area" style="height: <?= $widget->cropAreaHeight; ?>; width: <?= $widget->cropAreaWidth; ?>;">
        <div class="cropper-label">
            <div><?= Yii::t('jcrop', 'Drag Photo');?>
            <?= Yii::t('jcrop', 'Or');?>
            <?= Html::button(Yii::t('jcrop', 'Select Photo'),['class' => 'btn btn-primary']) ?></div>
        </div>
    </div>

    <div class="cropper-buttons">
        <?= Html::button(Yii::t('jcrop', 'Crop Photo'),['class' => 'btn btn-xs btn-success crop-photo hidden']) ?>
        <?= Html::button(Yii::t('jcrop', 'Select Another Photo'),['class' => 'btn btn-xs btn-info upload-new-photo hidden']) ?>
    </div>
